...
class _HomePageState extends State<HomePage> {
              ...
              child: SingleChildScrollView(
                ...
                children: <Widget>[
                  ...
                  ListView.builder(
                      ...
                      itemCount: _homeEntity.floorGoods.length,
                      itemBuilder: (BuildContext context, int index) {
                        return _floorGoodsWidget(_homeEntity.floorGoods[index]);
                      })
                ],
              )),
              onRefresh: () async {
  ...
  Widget _floorGoodsWidget(FloorGoods floorGoods) {
    return Container(
      child: Column(
        children: <Widget>[
          Container(
